...
{
    /// <summary>
    /// A temporary container for transcoding a <see cref="MediaCapture"/> into a stream.
    /// </summary>
    public class TemporaryCaptureFileStore : IDisposable
    {
        ...
        public static async Task<TemporaryCaptureFileStore> Create(MediaCapture mediaCapture, string fileName)
        {
